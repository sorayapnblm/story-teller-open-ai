  ...
  return (
    <div className='story-teller-choice'>
      ...
      <div className='story-teller-choice-list' data-aos="fade-up" data-aos-duration="3000">
        <ul>
          <li>
            <Link to="/customize/fairy/Luna Dandelion" className="bubble-link">Luna Dandelion<br />the fairy.</Link>
          </li>
          <li>
            <Link to="/customize/pirate/Captain Scarlet" className="bubble-link">Captain Scarlet<br />the pirate.</Link>
          </li>
          <li>
          <Link to="/customize/witch/Seraphina Moonshadow" className="bubble-link">Seraphina Moonshadow<br />the witch</Link>
          </li>
        </ul>
      </div>
